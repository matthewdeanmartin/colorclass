...
@pytest.mark.parametrize(
    "in_,expected_colors,expected_no_colors",
    [
        ("", "", ""),
        ("test", "test", "test"),
        ...
        (
            "{b}A {red}B {green}{bgred}C {/all}",
            "\033[1mA \033[31mB \033[32;41mC \033[0m",
            "A B C ",
        ),
        (
            "C {/all}{b}{blue}{hiblue}{bgcyan}D {/all}",
            "C \033[0;1;46;94mD \033[0m",
            "C D ",
        ),
        ("D {/all}{i}\033[31;103mE {/all}", "D \033[0;3;31;103mE \033[0m", "D E "),
        ("{b}{red}{bgblue}{/all}{i}TEST{/all}", "\033[0;3mTEST\033[0m", "TEST"),
        (
            "{red}{green}{blue}{black}{yellow}TEST{/fg}{/all}",
            "\033[33mTEST\033[0m",
            "TEST",
        ),
        (
            "{bgred}{bggreen}{bgblue}{bgblack}{bgyellow}TEST{/bg}{/all}",
            "\033[43mTEST\033[0m",
            "TEST",
        ),
